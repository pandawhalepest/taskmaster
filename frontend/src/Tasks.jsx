  ...
  function addTasks(user) {
    ...
    setTasks(old => ({
     ...
     //add a new blank task object with default properties for specidiic user
      [user]: [...(old[user] || []), { task: '', desc: '', done: false, completed: false }],
    }));
  }
...
function markAssigned(user, index, taskText, descText) {
  ...
  setTasks(prev => {
    ...
    updated[index] = { ...updated[index], task: taskText, desc: descText, done: true }; 
                  ...
                  {!done ? (
                    ...
                    <form
                      ...
                      onSubmit={e => {
                        ...
                        const taskText = e.target.querySelector('#user-task').value;
                        //get descirption input value
                        const descText = e.target.querySelector('#description').value;
