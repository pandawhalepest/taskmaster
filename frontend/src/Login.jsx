...
//prevent broswer refresh when submitting login
e.preventDefault()
//try catch block
try {
//send post request with post method, content-type headers, and body strigifying out username and password
...
<div id = 'login'>
    ...
    {/* Login title */}
       ...
       <form id = 'login-form' onSubmit = {postLogin}>
        {/* username text box */}
        <input type = 'text' id = 'login-username' placeholder = 'username...' value = {username} onChange = {(e) => setUsername(e.target.value)} />
        {/* password text box */}
        <input type = 'password' id = 'login-password' placeholder = 'password...' value = {password} onChange = {(e) => setPassword(e.target.value)}/>
       </form>
        {/* button to submit */}
